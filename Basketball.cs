...
public class Basketball : MonoBehaviour
{
    ...
    private GameObject girdi;
    [SerializeField]
    public AudioSource boardSes;
    [SerializeField]
    public GameObject cember1;
    [SerializeField]
    public GameObject cember2;
    [SerializeField]
    public GameObject sagcember;
    public EdgeCollider2D cember2edge;
    public BoxCollider2D cember1edge;
    public EdgeCollider2D sagedge;
    ...
    private void Start()
    {
        ...
        girdi = GameObject.Find("cembergirdi");
        cember2edge = cember2.GetComponent<EdgeCollider2D>();
        cember2edge.enabled = false;
        cember1edge = cember1.GetComponent<BoxCollider2D>();
        cember1edge.enabled = false;
        sagedge = sagcember.GetComponent<EdgeCollider2D>();
        sagedge.enabled = false;
    ...
    {
        if (other.gameObject.name == "cembergirdi")
        {
            donmeaktif = false;
        ...
        if (other.gameObject.name == "pota")
        {
            ...
            cember1.SetActive(true);
            sagcember.SetActive(true);
            cember1edge.enabled = true;
            cember2edge.enabled = true;
            sagedge.enabled = true;
            boardSes.Play();
        }
        if (other.gameObject.name == "ilkcember")
        {
            cember2.SetActive(true);
            cember1.SetActive(true);
            sagcember.SetActive(true);
        ...
        if (hasplayed)
        {
            ...
            if (other.gameObject.name == "cember" || other.gameObject.name == "cember2")
            {
                fileses.Play();
                hasplayed = false;
